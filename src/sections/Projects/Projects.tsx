...
const Projects = () => {
  ...
  const projects = [
    // Education Management System (06/2025 – 02/2026)
    {
    ...
    {
      title: t("projects.melodix.title"),
      description: t("projects.melodix.description"),
      role: t("projects.melodix.role"),
      duration: t("projects.melodix.duration"),
      teamSize: t("projects.melodix.teamSize"),
      technologies: [
        "NextJS",
        "NodeJS",
        "PostgreSQL",
    ...
    // Nexa-mart - AI Retail Platform (2025)
    {
      ...
      github: [
        "https://github.com/haubtm/nexa-mart-web",
        "https://github.com/haubtm/nexa-mart-app",
      ],
